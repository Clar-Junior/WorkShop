/*function imageChanger() {
    if (document.getElementById("img1").src == "/Images/img1.jpg") {
        (document.getElementById("img2").src == "/Images/img2.jpg")
    } 
    if ((document.getElementById("img2").src == "/Images/img2.jpg")) {
        (document.getElementById("img3").src == "/Images/img3.jpg")
    } 
    if ((document.getElementById("img3").src == "/Images/img3.jpg")) {
        (document.getElementById("img4").src == "/Images/img4.jpg")
    } 
    else ((document.getElementById("img4").src == "/Images/img4.jpg")) {
